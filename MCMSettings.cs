...
namespace KnockedDownHeroesInfluencesTroops
{
    internal class MCMSettings : AttributeGlobalSettings<MCMSettings>
    {
        ...
        [SettingPropertyBool("{=KDHIT_XAjTGu}Enable This Modification", Order = 0, RequireRestart = false, HintText = "{=KDHIT_AD25fH}Toggle this modification. [Default: enabled]")]
        [SettingPropertyGroup("{=KDHIT_LIubXv}Main settings", GroupOrder = 0)]
        public bool EnableThisModification { get; set; } = true;

        [SettingPropertyBool("{=KDHIT_SZkRRR}Show On-Screen Notifications", Order = 1, RequireRestart = false, HintText = "{=KDHIT_cNPmeY}Toggle on-screen notifications when any hero is knocked down. [Default: enabled]")]
        [SettingPropertyGroup("{=KDHIT_LIubXv}Main settings", GroupOrder = 0)]
        ...
        [SettingPropertyGroup("{=KDHIT_moZQWd}Morale penalties when heroes are knocked down", GroupOrder = 1)]
        ...
        [SettingPropertyGroup("{=KDHIT_bYRqo3}Technical settings", GroupOrder = 2)]
